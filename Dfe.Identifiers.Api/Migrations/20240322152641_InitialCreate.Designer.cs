...
namespace Dfe.Identifiers.Api.Migrations
{
    ...
    [Migration("20240322152641_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.EducationEstablishmentTrust", b =>
                {
                    b.Property<int>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.Establishment", b =>
                {
                    b.Property<long?>("SK")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTime?>("GiasLastChangedDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("GiasLastChangedDate");
                    ...
                    b.Property<int?>("NumberOfBoys")
                        .HasColumnType("int")
                        .HasColumnName("NumberOfBoys");

                    b.Property<int?>("NumberOfGirls")
                        .HasColumnType("int")
                        .HasColumnName("NumberOfGirls");
                    ...
                    b.Property<int?>("SenUnitCapacity")
                        .HasColumnType("int")
                        .HasColumnName("SenUnitCapacity");

                    b.Property<int?>("SenUnitOnRoll")
                        .HasColumnType("int")
                        .HasColumnName("SenUnitOnRoll");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.EstablishmentType", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.IfdPipeline", b =>
                {
                    b.Property<long?>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.LocalAuthority", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.Trust", b =>
                {
                    b.Property<long?>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.TrustType", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.Establishment", b =>
                {
                    b.HasOne("Dfe.Identifiers.Api.Models.EstablishmentType", "EstablishmentType")
                        .WithMany()
                        .HasForeignKey("EstablishmentTypeId");

                    b.HasOne("Dfe.Identifiers.Api.Models.LocalAuthority", "LocalAuthority")
                        .WithMany()
            ...
            modelBuilder.Entity("Dfe.Identifiers.Api.Models.Trust", b =>
                {
                    b.HasOne("Dfe.Identifiers.Api.Models.TrustType", "TrustType")
                        .WithMany()
