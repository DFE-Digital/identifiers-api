...
namespace Dfe.Identifiers.Infrastructure.Migrations
{
    ...
    [Migration("20240328120816_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.EducationEstablishmentTrust", b =>
                {
                    b.Property<int>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.Establishment", b =>
                {
                    b.Property<long?>("SK")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.EstablishmentType", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.LocalAuthority", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.Trust", b =>
                {
                    b.Property<long?>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.TrustType", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.Establishment", b =>
                {
                    b.HasOne("Dfe.Identifiers.Domain.Models.EstablishmentType", "EstablishmentType")
                        .WithMany()
                        .HasForeignKey("EstablishmentTypeId");

                    b.HasOne("Dfe.Identifiers.Domain.Models.LocalAuthority", "LocalAuthority")
                        .WithMany()
            ...
            modelBuilder.Entity("Dfe.Identifiers.Domain.Models.Trust", b =>
                {
                    b.HasOne("Dfe.Identifiers.Domain.Models.TrustType", "TrustType")
                        .WithMany()
